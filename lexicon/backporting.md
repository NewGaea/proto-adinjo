...
**NOTE:** This list contains Adinjo Journalist words on the left, with an arrow `->` used to indicate the back-derived form. Note that these forms are not final, they are only a first-pass approach! Final forms, including all sound changes, will be highlighted in **strong** text.

**NOTE:** This list does not target _Proto-Adinjo_, but is included here are a stop-gap measure in the set-up of Atlantean as a proto-form of Adinjo Journalist.
...
+ **[acoré.ru](a/acoré.md)** -> `acoré_wu` _ton verb_ unfold, open, bloom or blossom
+ **[aimi](a/aimi.md)** _noun_ eye
+ **[aire.nd](a/aire.md)** -> `aire_ind`	_ton verb_ finding, learning, discovering
...
+ **[alma](a/alma.md).ru** -> `alma_wu` _ton verb_ ruling, leading, governing
...
+ **[alme.n](a/alme.md)** -> `alme_n` *ton verb* milking
...
+ **[amar.te](a/amar.md)** -> `amar_set` _ton verb_ crying, weeping, mourning
+ **[amen.ru](a/amen.md)** -> `amen_wu` _ton verb_ waking, awakening, invoking, calling upon
...
+ **[amkei.l](a/amkei.md)** -> `amkei_el` _ton verb_ cutting, splitting, separating, removing, shearing; dividing
+ **[amur.ent](a/amur.md)** -> `amur_ind`	_ton vb_	scattering, spreading, sowing
+ **[andèn](a/andèn.md)**	_desc_	holy
  + **[andenin](a/andenin.md)**	_noun_	holiness
+ **Andurusidin**	_p noun_	Andurusian
+ **[ane.ru](a/ane.md)** -> `ane_wu`	_ton vb_	using
...
+ **[ani.ru](a/ani.md)** -> `ani_wu` _ton vb_	being (as in, “to be or not to be…”)
  + **[an-](a/an.md)**	_desc pfx_	expresses that the word is a statement of state or status, “to be x”
+ **[anis.wa](a/anis.md)** -> `anis_wu` _ton vb_	reading
...
+ **[anko.ro](a/anko.md)** -> `anko_wu`	_ton vb_	existing
  + **ankomar**	_noun_	existence
+ **[ajan](a/ajan.md)**	_p noun_	Lord (the Lord, divine)
+ **[ar.i](a/ar.md)** -> `ar_y`	_ton vb_	throwing
+ **[aram.el](a/aram.md)** -> `aram_el`	_ton vb_	passing, going through, going beyond
+ **[arlic](a/arlic.md)**	_noun_	pen, a permanent writing implement
+ **[armo](a/armo.md)**	_prep_	because, for the sake or purpose of
+ **arus.é** -> `arus_y`	_ton vb_	sitting, lounging
+ **aruʃ.en** -> `arusy_n`	_ton vb_	seating, providing or offering seats
  + **aruʃ**	_noun_	seat, chair, cushion, sofa
+ **arzol**	_desc_	blue
+ **asen.ru** -> `asen_wu`	_ton vb_	biting
  + **asenger**	_noun_	bite (the physical remains or damage of a bite)
+ **asent**	_noun_	east, rising to the right
+ **aʃa**	_noun_	peace
  + **aʃaun**	_noun_	horse
  + **aʃaus**	_desc_	peaceful
+ **aʃurt.as** -> `aʃurtx`	_ton vb_	raiding
...
+ **ause.ne** -> `ause_n`	_ton vb_	lying (down), laying
+ **ayas.uri** -> `ayas_y`	_ton vb_	comforting, soothing, calming
  + **ayastel**	_noun_	comfort
+ **aye**	_noun_	hand; may be literal or figurative
+ **aygins.ten** -> `aygins_n`	_ton vb_	playing (a game), acting, engaging in a hobby or pursuit of passion
+ **axen**	_desc_	last, final, the last, the final; term of absolution, indicates finality

## B

- **ba-**	_n pfx_	this; proximate demonstrative
- **baci.re** -> `baci_wu`	_ton vb_	seeing, viewing; watching
